...
#### How to flash image to your storage
  ...
  * [How to boot the image (includes ) from SD Card - LEC-iMX8M Plus Modules](https://github.com/ADLINK/meta-adlink-nxp/wiki/02.-How-to-install-Yocto-Image-into-SD-Card#lec-imx8m-plus-supported)
  ...
  * [How to boot the image (includes u-boot) from eMMC - LEC-iMX8M Plus, LEC-iMX8M, LEC-iMX6R2, LEC-iMX6 Modules](https://github.com/ADLINK/meta-adlink-nxp/wiki/03.-How-to-install-Yocto-Image-into-eMMC)
